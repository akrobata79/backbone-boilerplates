...
$(function() {
    ...
    var OneBlock = Backbone.Model.extend({
        defaults: { x:50, y:50, width:150, height:150, color:'black' },
    ...
    var Document = Backbone.Collection.extend({ model: OneBlock });
...
//            $(this.el).append(theH);
    ...
    $('#new-rectangle').click(function() {
        document.add(new OneBlock());
    });

    $('#new-circle').click(function() {
        document.add(new OneBlock({ circle: true }));
    });
